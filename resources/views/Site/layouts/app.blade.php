...
<head>
	...
	<link rel="stylesheet" href="{{ asset('Site/rs-plugin/css/settings.css') }}">
...
@yield('content')
		    ...
		    <footer id="footWrapper">
				    ...
				    <div class="container">
					    <div class="row">
                            ...
                            <div class="cell-3">
                                ...
                                <p>Welcome to EXCEPTION Responsive multipurpose html template, we always present our products features with high graphic design and high code quality .</p>
			    ...
			    <!-- footer bottom bar end -->
							...
							<script type="text/javascript" src="{{ asset('Site/rs-plugin/js/jquery.themepunch.tools.min.js') }}"></script>
							<script type="text/javascript" src="{{ asset('Site/rs-plugin/js/jquery.themepunch.revolution.min.js') }}"></script>

							<!-- Animate numbers increment -->
							<script type="text/javascript" src="{{ asset('Site/js/jquery.animateNumber.min.js') }}"></script>

							<!-- slick slider carousel -->
							<script type="text/javascript" src="{{ asset('Site/js/slick.min.js') }}"></script>

							<!-- Animate numbers increment -->
							<script type="text/javascript" src="{{ asset('Site/js/jquery.easypiechart.min.js') }}"></script>

							<!-- PrettyPhoto script -->
							<script type="text/javascript" src="{{ asset('Site/js/jquery.prettyPhoto.js') }}"></script>

							<!-- Share post plugin script -->
							<script type="text/javascript" src="{{ asset('Site/js/jquery.sharrre.min.js') }}"></script>

							<!-- Product images zoom plugin -->
							<script type="text/javascript" src="{{ asset('Site/js/jquery.elevateZoom-3.0.8.min.js') }}"></script>

							<!-- Input placeholder plugin -->
							<script type="text/javascript" src="{{ asset('Site/js/jquery.placeholder.js') }}"></script>

							<!-- Tweeter API plugin -->
							<script type="text/javascript" src="{{ asset('Site/js/twitterfeed.js') }}"></script>

							<!-- Flickr API plugin -->
							<script type="text/javascript" src="{{ asset('Site/js/jflickrfeed.min.js') }}"></script>

							<!-- MailChimp plugin -->
							<script type="text/javascript" src="{{ asset('Site/js/mailChimp.js') }}"></script>

							<!-- NiceScroll plugin -->
							<script type="text/javascript" src="{{ asset('Site/js/jquery.nicescroll.min.js') }}"></script>
