                ...
                <div id="contentWrapper">
                    <div class="page-title title-1">
                        <div class="container">
                            <div class="row">
                                <div class="cell-12">
                                    <h1 class="fx" data-animate="fadeInLeft">Users</h1>
                                   
                                    <div class="cart-icon fx" data-animate="fadeInRight">
                                        <div>
                                            <a href=""  class="btn btn-primary mb-4">+Add New</a>
                                        </div>
                        ...
                        <div class="container">
                            <table class="table-style2">
                                <thead>
                                      <tr>
                                    <th>#</th>
                                    <th class="width-5">first name</th>
                                    <th class="width-5">last name</th>
                                    <th class="width-5">phone</th>
                                    <th class="width-15">Country</th>
