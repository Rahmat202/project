                ...
                <div id="contentWrapper">
                    <div class="page-title title-1">
                        <div class="container">
                            <div class="row">
                                <div class="cell-12">
                                    <h1 class="fx" data-animate="fadeInLeft">Cities</h1>
                                   
                                    <div class="cart-icon fx" data-animate="fadeInRight">
                                        <div>
                                            <a href="{{ route('create.city') }}"  class ="btn btn-success btn-lg">+ Add New</a>
                                        </div>
                        ...
                        <div class="container">
                            <table class="table-style2">
                                <thead>
                                    ...
                                    <th class="width-10">City Name</th>
                             ...
                             <tr>
                                ...
                                {{-- <td>{{ $city->country_id as Countryname }}</td> --}}
                                <td>{{ \App\Models\Country::where('id',$city->country_id)->value('name') }}</td>
                                <td>{{ $city->name }}</td>
                                

                                <td>
                                    <a href="{{ route('edit.city',$city->id) }}" class="btn btn-warning btn-sm"><span class="fa fa-edit"></span></a>
                                            <a href="{{ route('delete.city',$city->id) }}" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                </td>
