					...
					<div class="container">
						<div class="row">
							<div class="cell-7 contact-form fx" data-animate="fadeInLeft">
			    				...
			    				<form action="{{ route('register.custom') }}" id="reg_form" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-input">
			    						<label>Password<span class="red">*</span></label><input type="password" required class="form-control">
			    					</div>
			    					<div class="form-input">
			    						<label>Confirm Password<span class="red">*</span></label><input type="password" required class="form-control">
			    					</div>
