                        ...
                        <div class="container">
                            <div class="row">
                                <div class="cell-7 contact-form fx" data-animate="fadeInLeft" id="contact">
                                    ...
                                    <form class="form-signin cform" method="POST" action="{{ route('update.country') }}" id="cform" autocomplete="on">
                                        @csrf
										<input type="hidden" name="id" value="{{ $country->id }}">
                                        <div class="form-input">
                                            <label>Country Name<span class="red">*</span></label>
                                            <input type="text" required="required" name="name" value="{{ $country->name }}">
                                        </div>
