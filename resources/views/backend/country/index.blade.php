                ...
                <div id="contentWrapper">
                    <div class="page-title title-1">
                        <div class="container">
                            <div class="row">
                                <div class="cell-12">
                                    <h1 class="fx" data-animate="fadeInLeft">Countries</h1>
                                    
                                    <div class="cart-icon fx" data-animate="fadeInRight">
                                        <div>
                                            <a href="{{ route('create.country') }}"  class ="btn btn-success btn-lg">+ Add New</a>
                                        </div>
                        ...
                        <div class="container">
                            <table class="table-style2">
                             ...
                             <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit.country',$country->id) }}" class="btn btn-warning btn-lg"><span class="fa fa-edit"></span></a>
                                    {{-- <form action="{{ route('delete.country', $country->id) }}" method="post">
                                        @csrf()
                                        <button type="submit">delete</button>
                                    </form> --}}
                                    <a href="{{ route('delete.conuntry',$country->id) }}" class="btn btn-danger btn-lg"><span class="fa fa-trash"></span></a>
                                </td>
