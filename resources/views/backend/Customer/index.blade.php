                            ...
                            <div class="row">
                                <div class="cell-12">
                                    ...
                                    <div class="cart-icon fx" data-animate="fadeInRight">
                                        <div>
                                            <a href="{{ route('create.customer') }}"  class ="btn btn-success btn-lg">+ Add New</a>
                                        </div>
                        ...
                        <div class="container">
                            <table class="table-style2">
                                <thead>
                                    ...
                                    <th class="width-10">Picture Name</th>
                                    <th class="width-5">City</th>
                                    <th class="width-5">Picture address</th>
                             ...
                             <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ asset('/uploads/customer'.'/'.$customer->image) }}" width="90px" height="80px" alt="Image">
                                </td>
                                <td>{{ $customer->city }}</td>
                                <td>{{ $customer->P_name }}</td>
                                <td>{{ $customer->keyword }}</td>

                                <td>
                                    <a href="{{ route('edit.customer',$customer->id) }}" class="btn btn-warning btn-sm"><span class="fa fa-edit"></span></a>
                                 <a href="{{ route('delete.customer',$customer->id) }}" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                </td>
