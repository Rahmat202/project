                        ...
                        <div class="container">
                            <div class="row">
                                <div class="cell-7 contact-form fx" data-animate="fadeInLeft" id="contact">
                                    ...
                                    method="POST" action="{{ route('store.traffic') }}" id="cform" autocomplete="on">
                            
                                        @csrf
                                        <div class="form-input">
                                            <label>System Date<span class="red">*</span></label>
                                            <input type="date" required="required" name="system_date" placeholder="sytem date">
                                        </div>
                                        <div class="form-input">
                                            <label>Page<span class="red">*</span></label>
                                            <input type="text" required="required" name="page" placeholder="page">
                                        </div>
                                        <div class="form-input">
                                            <label>City<span class="red">*</span></label>
                                            <input type="text" required="required" name="city" placeholder="city">
                                        </div>
                                        <div class="form-input">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <div class="form-input">
                                            ...
                                            <input type="text" required="required" name="sub_category" placeholder="sub category">
                                        </div>
                                        <div class="form-input">
                                            <label>Search Text<span class="red">*</span></label>
                                            <input type="text" required="required" name="serch_text" placeholder="search text">
                                        </div>
                                        <div class="form-input">
                                            <label>Customer Name<span class="red">*</span></label>
                                            <input type="text" required="required" name="customer_name" placeholder="customer name">
                                        </div>
                                        
                                        <div class="form-input">
                                            <label>IP Address<span class="red">*</span></label>
                                            <input type="text" id="webUrl" name="ip_address" required="required" placeholder="ip address">
                                        </div>
