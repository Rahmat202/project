						...
						<div class="row">
							...
							<div class="cell-9 top-menu">
								...
								<nav class="top-nav mega-menu">
									<ul>
										<li class="selected"><a href="portfolio-4-cols.html"><i class="fa fa-home"></i><span>Home</span></a>
										<!-- 	<ul>
										...
										<li><a href="feedback.html"><i class="fa fa-key"></i><span>Feedback</span></a>
											<!-- <ul>
									...
									<li><a href="about-us.html"><i class="fa fa-gift"></i><span>About Us</span></a>
										<!-- 	<ul>
												<li><a href="portfolio-2-cols.html">Portfolio 2 columns</a></li>
												<li><a href="portfolio-3-cols.html">Portfolio 3 columns</a></li>
												<li class="selected"><a href="portfolio-4-cols.html">Portfolio 4 columns</a></li>
												<li><a href="portfolio-full.html">Portfolio full</a></li>
												<li><a href="portfolio-single.html">Portfolio single</a></li>
												<li><a href="portfolio-single2.html">Portfolio single 2</a></li>
											</ul> -->
										</li>
										<li><a href="#"><i class="fa fa-suitcase"></i><span>Dashboard</span></a>
											<ul>
												
												<li><a href="{{ route('customer.index') }}">customer</a>
													
												</li>
												<li><a href="{{ route('country.index') }}">Countries</a></li>
												<li><a href="{{ route('category.index') }}">Categories</a></li>
												<li><a href="{{ route('city.index') }}">Cities</a></li>
												<li><a href="{{ route('traffic.index') }}">Traffic</a></li>
												<li><a href="{{ route('feedback.index') }}">Feedback</a></li>
												<li><a href="{{ route('index.user') }}">User</a></li>
											</ul>
									</li>
										<li><a href="blog.html"><i class="fa fa-home"></i><span>Blog</span></a></li>
										<li><a href="contact.html"><i class="fa fa-copy"></i><span>Contact us</span></a>
										<!-- 	<ul>
