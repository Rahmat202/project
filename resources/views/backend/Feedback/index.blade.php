                ...
                <div id="contentWrapper">
                    <div class="page-title title-1">
                        <div class="container">
                            <div class="row">
                                <div class="cell-12">
                                    <h1 class="fx" data-animate="fadeInLeft">Feedbacks</h1>
                                   
                                    <div class="cart-icon fx" data-animate="fadeInRight">
                                        <div>
                                            <a href="{{ route('create.feedback') }}" class ="btn btn-success btn-lg">+ Add New</a>
                                        </div>
                        ...
                        <div class="container">
                            <table class="table-style2">
                                <thead>
                                    ...
                                    <th class="width-10">Ip Address</th>
                             ...
                             <tr>
                                ...
                                <td>{{ $feedback->system_date }}</td>
                                <td>{{ $feedback->ip_address }}</td>
                               

                                <td>
                                    <a href="{{ route('edit.feedback',$feedback->id) }}" class="btn btn-warning btn-sm"><span class="fa fa-edit"></span></a>
                                 <a href="{{ route('delete.feedback',$feedback->id) }}" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                </td>
