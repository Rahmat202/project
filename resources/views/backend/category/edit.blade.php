                        ...
                        <div class="container">
                            <div class="row">
                                <div class="cell-7 contact-form fx" data-animate="fadeInLeft" id="contact">
                                    ...
                                    <form class="form-signin cform" method="POST" action="{{ route('update.category') }}" id="cform" autocomplete="on">
                                        @csrf
										<input type="hidden" name="id" value="{{ $category->id }}">
                                        <div class="form-input">
                                            <label>Category Name<span class="red">*</span></label>
                                            <input type="text" required="required" name="name" value="{{ $category->name }}">
                                        </div>
