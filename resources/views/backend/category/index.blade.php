                ...
                <div id="contentWrapper">
                    <div class="page-title title-1">
                        <div class="container">
                            <div class="row">
                                <div class="cell-12">
                                    <h1 class="fx" data-animate="fadeInLeft">Categories</h1>
                                   
                                    <div class="cart-icon fx" data-animate="fadeInRight">
                                        <div>
                                            <a href="{{ route('create.category') }}"  class ="btn btn-success btn-lg">+ Add New</a>
                                        </div>
                        ...
                        <div class="container">
                            <table class="table-style2">
                             ...
                             <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit.category',$category->id) }}" class="btn btn-warning btn-sm"><span class="fa fa-edit"></span></a>
                                    <a href="{{ route('delete.category',$category->id) }}" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                </td>
